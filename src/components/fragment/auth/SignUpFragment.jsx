                ...
                <div className="form h-full w-full">
                    ...
                    <div className="h-full w-full flex items-center justify-start ml-25">
                        <div className="flex flex-col gap-5 w-7/12">
                            ...
                            <TextCustom type='sm_500' textColor='text-secondary-300' classname='text-center'>have an accout ? <span className='text-information-600 font-bold'><Link to="/sign-in">sign In</Link></span></TextCustom>
                        </div>
                    </div>
                </div>
