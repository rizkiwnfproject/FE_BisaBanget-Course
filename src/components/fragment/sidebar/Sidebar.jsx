                        ...
                        <div className="hover:bg-information-300 hover:text-information-900 pl-5 py-5  ease-in-out transition-all duration-300">
                            <Link to="/user/class">
                                <div className="flex items-end gap-4">
                                    ...
                                    <TextCustom type="md_500">Kelas</TextCustom>
                                </div>
                            </Link>
                        </div>
                        <div className="hover:bg-information-300 hover:text-information-900 pl-5 py-5  ease-in-out transition-all duration-300">
                            <Link to="/user/subject">
                                <div className="flex items-end gap-4">
                                    ...
                                    <TextCustom type="md_500">Pelajaran</TextCustom>
                                </div>
                            </Link>
                        </div>
                        <div className="hover:bg-information-300 hover:text-information-900 pl-5 py-5  ease-in-out transition-all duration-300">
                            <Link to={data.data.role === "admin" ? "/user/teacher": "/user/class-advisor"}>
                                <div className="flex items-end gap-4">
                                    ...
                                    <TextCustom type="md_500">{data.data.role === "admin" ? "Teacher":"Wali Kelas"}</TextCustom>
                                </div>
                            </Link >
                        </div>
                        <div className="hover:bg-information-300 hover:text-information-900 pl-5 py-5  ease-in-out transition-all duration-300">
